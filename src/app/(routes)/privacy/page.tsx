const PrivacyPolicy = () => {
    return (
        <div className="min-h-screen bg-[#0B0B0F] text-[#E5E7EB] px-[30px] py-20 ">
            ...
            <h1 className="text-4xl font-bold my-8 text-white"> Privacy Policy </h1>

                <p className="text-sm text-[#9CA3AF] mb-8"> Effective Date: June 6, 2026 <br/> Last Updated: June 6,
                    2026 </p>
