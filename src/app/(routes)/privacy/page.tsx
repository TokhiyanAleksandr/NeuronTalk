const PrivacyPolicy = () => {
  return (
      <div className="min-h-screen bg-[#0B0B0F] text-[#E5E7EB] px-6 py-12 ">
        <div className="max-w-4xl mx-auto"> <h1 className="text-4xl font-bold my-8 text-white"> Privacy Policy </h1>

            <p className="text-sm text-[#9CA3AF] mb-8"> Effective Date: June 6, 2026 <br /> Last Updated: June 6, 2026 </p>
        ...
        <Section title="13. Contact Information">
          <p className="mb-2 font-medium">NeurOn Talks</p>
