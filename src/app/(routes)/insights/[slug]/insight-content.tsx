    ...
    return (
        <MainSection>
            <Section>
                ...
                {/*    <button*/}
                {/*        className="mb-[30px] inline-flex items-center justify-center rounded-lg border border-zinc-300 bg-white px-6 py-3 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-800">*/}
                {/*        <svg*/}
                ...
                <div
                    className="insight-content mt-4 text-white text-sm leading-relaxed group-hover:opacity-100 transition-opacity duration-500"
