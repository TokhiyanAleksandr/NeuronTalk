...
export const InsightCard = ({ item, index }: { item: any; index: number }) => {
    ...
    return (
        ...
        >
            <div className="max-h-[350px] min-h-[350px] w-[100%] relative aspect-[3/4] overflow-hidden border-none outline-none">
                <motion.img
                    whileHover={{ scale: 1.05 }}
                    transition={{ duration: 0.5 , ease: [0.33, 1, 0.68, 1] }}
                    src={item.image}
                    alt={item.title}
                    /* grayscale и чистое масштабирование */
